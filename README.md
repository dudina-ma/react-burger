...
Демо: [https://dudina-ma.github.io/react-burger/](https://dudina-ma.github.io/react-burger/)
...
- `npm run stylelint` - запускает проверку линтера для файлов стилей и исправляет проблемы, которые можно исправить автоматически,
