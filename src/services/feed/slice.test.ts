...
describe('feedSlice', () => {
  ...
  describe('connect', () => {
    it('должен включать isLoading, если заказов ещё нет', () => {
      ...
      const result = reducer(startState, connectFeed('wss://example.com/orders/all'));
  ...
  describe('disconnect', () => {
    it('должен сбрасывать состояние ленты заказов', () => {
      const startState = {
        error: 'Ошибка',
        isConnected: true,
        isLoading: true,
      ...
      const result = reducer(startState, disconnectFeed());
  ...
  describe('onOpen', () => {
    it('должен отмечать соединение открытым и очищать ошибку', () => {
      ...
      const result = reducer(startState, onOpen());
  ...
  describe('onClose', () => {
    it('должен отмечать соединение закрытым', () => {
      ...
      const result = reducer(startState, onClose());
  ...
  describe('onError', () => {
    it('должен сохранять ошибку и сбрасывать isLoading', () => {
      ...
      const result = reducer(startState, onError('Соединение разорвано'));
  ...
  describe('onMessage', () => {
    it('при успешном сообщении должен сохранить заказы и счётчики', () => {
      ...
      const result = reducer(startState, onMessage(successMessage));
